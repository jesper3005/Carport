...
<html>
    ...
    <body>
        ...
        <!-- Length(420) + 20 = y(20) -->
        <rect x="45" y="415" height="5" width="380" style="stroke: #292929; fill:none; stroke-width: 1.5;"/>
        ...
        <svg width="600" height="600">
            ...
            <!--Stolper-->
            <rect x="40" y="60" height="250" width="5" style="stroke: #292929; fill:none;"/>
            <rect x="435" y="60" height="250" width="5" style="stroke: #292929; fill:none;"/>
        </svg>
    </body>
</html>
