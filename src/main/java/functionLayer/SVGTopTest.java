...
public class SVGTopTest {
    ...
    private String createRemme(double length, double width) {
        ...
        //Vertical
        sb.append("<rect x=\"" + startPosX + "\" y=\"" + startPosY + "\" height=\"" + realLength + "\" width=\""+ remWidth +"\" style=\"stroke: #292929; fill:none; stroke-width: 1.5;\"/>");
        sb.append("<rect x=\"" + (width + 40) + "\" y=\"" + startPosY + "\" height=\"" + realLength + "\" width=\"" + remWidth + "\" style=\"stroke: #292929; fill:none; stroke-width: 1.5;\"/>");
    ...
    private String createStolper(double length, double width) {
        ...
        if (length <= 450) {
            //Back stolper
            sb.append("<rect x=\"" + x1 + "\" y=\"" + y + "\" height=\"10\" width=\"10\" style=\"stroke: #292929; fill:1;\"/>");
            sb.append("<rect x=\"" + x2 + "\" y=\"" + y + "\" height=\"10\" width=\"10\" style=\"stroke: #292929; fill:1;\"/>");
            //Front stolper
